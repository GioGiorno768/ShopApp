  ...
  const dataOverview = [
    {
      ...
      tag: "Nike React",
      desc: "Rewriting sports playbook for billions of athletes",
    },
    {
      id: 2,
      image:
      ...
      tag: "CoolApps",
      desc: "From mobile apps to gaming consoles",
    },
    {
      id: 3,
      image:
      ...
      tag: "Grumpy",
      desc: "Bringing Art to everything",
    },
  ];
  return (
              ...
              <div className="hs-carousel-slide" key={item.id}>
                ...
                >
                  <div className="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
                    <span className="block text-white">{item.tag}</span>
